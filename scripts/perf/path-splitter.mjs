...
try {
  ...
  assert.equal(appearance[11].opacity, 0)
  ...
  console.log('PASS: Path panel mounts; open/loop and MIDI/continuous modes save; speed and fade controls save; preview paints; no runtime errors.')
} catch (error) {
