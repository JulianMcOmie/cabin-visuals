...
export const MOVER_USER_INTERFACES: Partial<Record<string, UserInterfaceRendererDefinition>> = {
  ...
  wallpaper: lazyPanel(() => import('./FormationSplitterUserInterface'), 'WallpaperSplitterUserInterfaceRenderer'),
  fractal: lazyPanel(() => import('./FormationSplitterUserInterface'), 'FractalSplitterUserInterfaceRenderer'),
