...
- **UIStore** — selection (track single + multi, block set), collapsed tracks, opened MIDI blocks plus active editing block (piano-roll target), zoom levels (`tracksPixelsPerBeat`, `midiPixelsPerBeat`, `midiRowHeight`), panel visibility.
