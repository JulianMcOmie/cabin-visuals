    ...
    <div className="@container relative hidden md:flex h-12 flex-shrink-0 items-center gap-3 select-none px-4">
      ...
      <div className="flex min-w-0 flex-1 items-center gap-1 @[530px]:gap-1.5">
        ...
        <button
          ...
          title="Fast Preview - trades sharpness for smoother playback. Auto softens only while playing and caps particle emitters at 8,000. Fast caps particles at 4,000; Fastest at 1,000. Fast also drops shadows and fill lights; Fastest renders flat, unlit colour. Export always renders final quality."
