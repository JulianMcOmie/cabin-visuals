...
- `audioStorage.ts` / `videoStorage.ts` / `photoStorage.ts` — named bucket APIs sharing path minting and the XHR progress transport in `mediaStorage.ts`.
