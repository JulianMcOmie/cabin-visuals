...
import { midiRoll } from './library-midiroll'

// Lyric videos lead (the product's current wedge), then the other
// "bring your own material" starting points.
export const TEMPLATES: TemplateDef[] = [...LYRIC_TEMPLATES, silentFilm, wormhole, neonPsychedelic, monochrome, slideshow, midiRoll, promoCuts, crazyEdit]
